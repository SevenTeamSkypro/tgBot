...
public class OwnerDogDto {
    ...
    public OwnerDogDto(Long id, Long chatId, String firstName, String lastName, String phoneNumber, List<Dog> pets,
    ...
    public OwnerDogDto(Long chatId, String firstName, String lastName, String phoneNumber, List<Dog> pets,
                       LocalDateTime probation) {
        this.chatId = chatId;
        this.firstName = firstName;
        this.lastName = lastName;
    ...
    public boolean equals(Object o) {
        ...
        OwnerDogDto ownerDto = (OwnerDogDto) o;
